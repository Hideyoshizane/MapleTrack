...
router.get('/bossList/:username', authentication.extractUserInfo, authentication.ensureAuthentication,  bossController.getList);
...
router.get('/:username/:server/:characterClass', authentication.extractUserInfo, authentication.ensureAuthentication,  characterController.redirectCharacter);
router.get('/:username/:server/:characterClass/edit', authentication.extractUserInfo,authentication.ensureAuthentication,  characterController.editCharacter);
router.get('/class/:username/:server/:characterClass',authentication.extractUserInfo, authentication.ensureAuthentication,  characterController.getCharacterData);
router.get('/:username/:server', authentication.extractUserInfo, authentication.ensureAuthentication, characterController.fullCharacter);
